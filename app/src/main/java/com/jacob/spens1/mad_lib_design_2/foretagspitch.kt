...
class foretagspitch : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        array_företagspitch = arrayOf("Namn", "Siffra","Engelsk mening eller ord", "Substantiv i singular","Verb","Butikskedja","Land","Land","Siffra","Årtal","Hemsida","Namn på by","Låg siffra","Substantiv i plural","Hög siffra","Tidsenhet","Namn innehållande 3 boktstäver","Kändis","Kroppsdel i bestämd form","Siffra","")
