...
class matlagning : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        array_matlagning = arrayOf("Typ av fisk i bestämd form","Något illaluktande","Substantiv i bestämd form","Vätska","Verb","Klädesplagg i plural","Hög siffra","Ingrediens vid matlagning","Verb","Adjektiv som slutar på: a","Något som smakar äckligt","Ord man säger om något smakar gott","En känsla","Adverb","Substantiv i bestämd form","Siffra","Mätenhet","Vätska","Tidsspann","Något som är dåligt för kroppen att äta","Stark alkohol","Färg","Sjukdom","Kroppsdel","")
        ...
        confirm_button_matlagning.setOnClickListener {
            if (counter < array_matlagning.size) {
                ...
                counter++
                textStory_matlagning = "Hejsan, idag ska vi lära oss laga inbakad " + array_matlagning[0] + " med smak av " + array_matlagning[1] + ". Det första steget är väldigt enkelt, ta fram " + array_matlagning[2] + " och " + array_matlagning[0] + ", nu kan ni antingen välja att blanda ned " + array_matlagning[0] + " med " + array_matlagning[3] + " eller använda " + array_matlagning[2] + " och sakta " + array_matlagning[4] + " på fisken. Nästa steg är lite svårare, nu ska ni ta på er era " + array_matlagning[5] + " för att ingen ska bränna sig, för vi ska värma upp ugnen till " + array_matlagning[6] + " grader. Medans ugnen blir varm ska ni blanda ned " + array_matlagning[7] + " med fisken, ett tips nu är att " + array_matlagning[8] + " riktigt rejält med fisken för att få fram den där " + array_matlagning[9] + " smaken av " + array_matlagning[10] + ". " + array_matlagning[11] + " nu börjar man bli lite " + array_matlagning[12] + ", " + array_matlagning[0] + " luktar ju redan väldigt " + array_matlagning[13] + ". Bara några steg kvar, nu ska vi ta fram kockens viktigaste redskap, " + array_matlagning[14] + " och den ska vi använda för att blanda ihop fisken med " + array_matlagning[15] + " " + array_matlagning[16] + " " + array_matlagning[17] + ". Nu kan vi slänga in fisken i ugnen, den ska vara där i " + array_matlagning[18] + " så medans vi väntar kan man ta sig lite " + array_matlagning[19] + " som aptitretare eller för dom vuxna ett glas " + array_matlagning[20] + ". När " + array_matlagning[0] + " börjar se " + array_matlagning[21] + " ut är den redo att tas ut ur ugnen. Nu kan ni krydda med " + array_matlagning[1] + " och servera, om fisken varit i ugnen för kort tid finns det risk att man kan få " + array_matlagning[22] + " så var väldigt försiktiga innan ni börjar äta. Skär också gärna bort fiskens " + array_matlagning[23] + " då den inte smakar särskilt gott. Nu är allt redo att serveras, smaklig måltid!"
