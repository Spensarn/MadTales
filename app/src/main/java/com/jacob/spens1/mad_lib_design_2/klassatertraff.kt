    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nästa_button_klass.setOnClickListener {
            if (counter1 < array_klass_p2.size) {
                ...
                counter1++
                textStory_klass = spelare1 + ": Ne men " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[0] + " hej på dig! Det var inte igår! \n " +
                        spelare2 +": Hej " + klass_class.spelare1 + " ne det var det inte, hur är det?\n " +
                        spelare1 +": Jo förutom att jag har fått " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[1] + ", " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[2] + " har gjort slut med mig och jag har fått " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[3] + " så är allt bra. Själv?\n " +
                        spelare2 +": Ne allt är bra för mig, jag jobbar fortfarande som " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[0] + ", är inne på mitt " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[1] + "e år nu.\n "+
                        spelare1 +": Vad kul! Ne jag har fått nytt jobb som " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[4] + ", det är inte jättekul men jag tjänar bra, vi har lite annat system där, lönen man får är " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[5] + ".\n "+
                        spelare2 +": Ehm okej, ja det låter ju bra, jag och min partner har faktiskt skaffat barn, eller rättare sagt " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[2] + " stycken, vårt senaste heter " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[3] + " och är väldigt " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[4] + ".\n" +
                        spelare1 +": Jaha vad kul! Själv har man ju bara sina " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[6] + " stycken " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[7] + " hemma, men så kan det va, hoppas man kan hitta någon trevlig person och " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[8] + " på snart.\n"+
                        spelare2 +": Ja men det gör du nog! Kommer ihåg att du höll mycket på med " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[5] + " på fritiden, gör du fortfarande det?\n"+
                        spelare1 +": Nja jag har slutat, har börjat att " + com.jacob.spens1.mad_lib_design_2.array_klass_p2[9] + ", det är ganska kul! Vad gör du när du får lite ledig tid?\n"+
                        spelare2 +": Jag sitter bara framför " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[6] + " hela dagarna så inget intressant, men jag måste iväg nu och " + com.jacob.spens1.mad_lib_design_2.array_klass_p1[7] + " så vi får höras senare\n!"+
