...
class nyheter : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        array_nyheter = arrayOf("Namn på husdjur","Land","Siffra","Substantiv i plural","Superhjälte","Stad i Sverige","Person i rummet, förnamn och efternamn","Verb i dåtid","Substantiv i plural","Kroppsdel","Siffra","Mätenhet","Känd person","Känd idrottsman","Olaglig aktivitet som slutar på: t","")
